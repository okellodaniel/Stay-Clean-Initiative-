...
// sex.addEventListener('blur',genderVerify,true);
// role.addEventListener('blur',role_verify,true);
...
// Regular Expressions
const nameRegExp = /^.{2,50}[A-Za-z]+$/; // Regular expression for names
const ninRegExp = /([C-M0-9A-Z0-9A-Z]{14})/;//regular Expression for National Id
